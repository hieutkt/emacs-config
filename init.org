...
#+BEGIN_SRC emacs-lisp
  ...
  ;; (use-package kaolin-themes :config (load-theme 'kaolin-valley-light t))
  ;; (use-package flatui-theme :config (load-theme 'flatui t))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-roam-graph
    :straight org-roam
    :init
    ;; If neato is available
    (setq org-roam-graph-executable (executable-find "neato")
          org-roam-grapher-extra-options '(("overlap" . "false"))
          org-roam-graph-exclude-matcher '("journal" "Notes on"))
    )
