...
#+END_SRC
** Hydra
[[https://github.com/abo-abo/hydra][Hydra]] is an interesting packages and I will spend time testing around with it.

The following hydras are draft
#+BEGIN_SRC emacs-lisp :tangle no
...
_s-f_: file            _a_: ag                _i_: Ibuffer           _c_: cache clear
 ...
 _fd_: file curr dir   _o_: multi-occur     _s-k_: Kill all buffers  _X_: cleanup non-existing
  ...
  ----------------------------------------------
  [_p_]   Next :tangle no    [_n_]   Next :tangle no    [_l_] Edit lines
