...
#+BEGIN_SRC emacs-lisp
    (use-package org-ref
      ...
      (setq org-ref-default-bibliography '("~/Dropbox/references/articles.bib")
	    org-ref-bibliography-notes "~/Dropbox/references/articles.org"
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package helm-bibtex
    :config
    ;; Set bib folder
    (setq helm-bibtex-bibliography '("~/Dropbox/references/articles.bib"
				     "~/Dropbox/references.bib")
	  helm-bibtex-library-path "~/Dropbox/references/pdfs"
	  helm-bibtex-notes-path "~/Dropbox/references/articles.org")
